...
async def openai_complete(
    ...
    **kwargs,
    ...
    # MẶC ĐỊNH BẮT ĐƯỜNG TRUYỀN SANG GROQ NẾU DÙNG LLAMA 3.3 CỦA GROQ
    # (Hoặc bạn có thể check nếu model_name chứa "llama" hoặc "versatile")
    if "llama" in model_name.lower():
        kwargs["base_url"] = "https://api.groq.com/openai/v1"
        kwargs["api_key"] = os.environ.get("OPENAI_API_KEY") # Sẽ lấy Key gsk_ của bạn
        
        # SỬA LUÔN LỖI JSON_SCHEMA TẠI ĐÂY
        if keyword_extraction:
            # Không cho phép ghi đè response_format thành GPTKeywordExtractionFormat ở hàm dưới
            keyword_extraction = False 
            kwargs["response_format"] = {"type": "json_object"}
